...
import com.fajar.feature.main.home.databinding.FragmentHomeScreenBinding
import com.fajar.home.fragment.adapter.EnumTaskListAdapterViewType
import com.fajar.home.fragment.adapter.HomeAdapterEvent
import com.fajar.home.fragment.adapter.TaskListAdapter
...
import com.fajar.navigation.navigateWithArgs
...
class HomeScreenFragment : Fragment(), HomeAdapterEvent {
    ...
    private fun showDetailBottomSheet(task: Task) {
        navController.navigateWithArgs(HomeNavigationNode.TASK_DETAILS_DIALOG, bundleOf(com.fajar.home.fragment.TaskDetailDialogFragment.TASK_EXTRA_KEY to task))
    }
